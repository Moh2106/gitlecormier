export const alentours = [
...

      {
            ...
            maps: "https://goo.gl/maps/K1TMPJN5AberMWeXA",
      },
...

      {
            ...
            maps: "https://goo.gl/maps/HxEaZZq2mL5ngpaE8",
      },
...

      {
            ...
            description:
                  "La communauté monastique de l'abbaye Saint-Wandrille perpétue une longue tradition de prière dans le recueillement et le travail, la solitude et la communion.",
...

      {
            ...
            description:
                  "N°1 de la formation à la conduite sécurité sur site protégé, Centaure se distingue par ses infrastructures et ses équipements au service des conducteurs. Notre objectif : vous faire vivre le risque routier pour mieux l’éviter.  Stage de prévention Découvrez nos stages de prévention sur site protégé ! Stage de récupération de points. Récupérez 4 points en 2 jours dans un cadre unique dédié à la prévention routière ! Stage Groupama Spécial clients Groupama. Réservez votre stage de prévention ! ",
      ...
      {
            id: 2,
            titre: "PARC NATUREL REGIONAL DES BOUCLES DE LA SEINE NORMANDE",
            description: "",
